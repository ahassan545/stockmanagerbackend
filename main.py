...
async def predict(request: Request):
    ...
    result = service.predict(data["ticker"], datetime.strptime(data["date"], "%Y-%m-%d"))   
...
def run_news_agent():
    ...
    news_instructions = "You are a stock news agent, only use provided tools to get stock news."
